<script lang="ts">
    ...
    let firmaCanvas: HTMLCanvasElement | undefined = undefined;
                    ...
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <p class="text-sm text-gray-500 mt-1">
                                🎯 Planeación interactiva - ¡Selecciona y listo!
                            </p>
                        </div>
                        <!-- Barra de tiempo total -->
                        <div class="bg-indigo-50 px-4 py-2 rounded-lg border border-indigo-200">
                            <span class="text-xs text-indigo-600 font-medium">Tiempo Total:</span>
                            <span class="text-lg font-bold text-indigo-700 ml-2">{tiempoTotal} min</span>
                        </div>
                    </div>

                    <!-- Objetivos y Competencias -->
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <!-- Objetivos con botón automático -->
