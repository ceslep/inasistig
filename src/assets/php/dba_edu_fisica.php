...
// -----------------------------------------------------------------------------
// CICLO 1: GRADOS 1° A 3° - EDUCACIÓN FÍSICA (DBA)
...
// -----------------------------------------------------------------------------
// CICLO 2: GRADOS 4° A 5° - EDUCACIÓN FÍSICA (DBA)
// -----------------------------------------------------------------------------
$dba_ef_4_5 = [
    // Corporeidad y motricidad
...
// -----------------------------------------------------------------------------
// CICLO 3: GRADOS 6° A 7° - EDUCACIÓN FÍSICA (DBA)
// -----------------------------------------------------------------------------
$dba_ef_6_7 = [
    // Corporeidad y motricidad
...
// -----------------------------------------------------------------------------
// CICLO 4: GRADOS 8° A 9° - EDUCACIÓN FÍSICA (DBA)
// -----------------------------------------------------------------------------
$dba_ef_8_9 = [
    // Corporeidad y motricidad
...
// -----------------------------------------------------------------------------
// CICLO 5: GRADOS 10° A 11° - EDUCACIÓN FÍSICA (DBA)
// -----------------------------------------------------------------------------
$dba_ef_10_11 = [
    // Corporeidad y motricidad
...
echo json_encode([
    "status" => "success",
    "source" => "Derechos Básicos de Aprendizaje (DBA) - Educación Física, Recreación y Deporte - Ministerio de Educación Nacional de Colombia",
    "nota" => "DBA organizados por cinco dimensiones: Corporeidad y motricidad, Expresión corporal, Lúdica y recreación, Salud y cuidado del cuerpo, Convivencia y valores. Estructura compatible con sistema de planeación inasistig.",
    "dimensiones" => [
    ...
    "competencias_transversales" => [
        "autonomia_corporal" => "Capacidad para tomar decisiones responsables sobre el cuidado y desarrollo del propio cuerpo.",
        "trabajo_equipo" => "Habilidad para colaborar, comunicarse y coordinar acciones con otros en contextos deportivos.",
        "resolucion_conflictos" => "Capacidad para manejar situaciones competitivas y de juego de manera constructiva.",
        "pensamiento_critico" => "Análisis reflexivo sobre prácticas corporales, salud y cultura deportiva.",
        "ciudadania_deportiva" => "Participación responsable y ética en prácticas deportivas y recreativas."
    ],
    "data" => $datos
