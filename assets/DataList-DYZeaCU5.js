import{p as Gt,s as ie,b as It,o as Nt,j as C,e as Mt,$ as Ot,f as Se,b0 as d,k as r,i as T,m as e,A as ne,t as w,r as o,g as v,y as a,B as ge,ae as Ht,at as tt,h as Rt,N as $,v as z,q as U,l as at,n as Ae,bQ as Ut,x,J as st,d as qt}from"./svelte-W9WRJD5Y.js";import{p as Vt,c as Bt}from"./App-cywTfMYd.js";import{e as Zt}from"./index-DO5bjpmR.js";import{S as Jt}from"./SkeletonLoader-ZSGhT7fh.js";import"./pdf-wbV6RFuj.js";import"./ui-DZFw2LIZ.js";function rt(p){try{return new Date(p).toLocaleDateString("es-CO",{year:"numeric",month:"long",day:"numeric"})}catch{return p}}function Kt(p){return`
  <div class="header">
  ...
  `}function Qt(p,be,B,q){const W=rt(p.fecha_limite),j=rt(new Date().toISOString().split("T")[0]);return`
  <div class="page-item">
    ${Kt(be)}
    ...
    <table class="info-table">
      ...
      <tr>
        ...
        <td class="info-cell"><span class="lbl">Fecha Límite</span><span class="val bold">${W}</span></td>
      </tr>
    </table>
  ...
  `}function lt(p,be){Array.isArray(p)||(p=[p]);const B=p[0]?.estudiante||"",q=p.map((P,G)=>Qt(P,be,!0,G===p.length-1)).join(""),W=`<!DOCTYPE html>
<html>
<head>
<meta charset="utf-8">
