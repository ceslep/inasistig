import{p as Gt,s as ie,b as It,o as Nt,j as C,e as Mt,$ as Ot,f as Se,aY as d,k as r,i as T,m as e,A as ne,t as w,r as o,g as v,y as a,B as ge,aa as Ht,aq as tt,h as Rt,N as $,v as z,q as U,l as at,n as Ae,bs as Ut,x,J as st,d as qt}from"./svelte-Cb7dEq8z.js";import{p as Vt,c as Bt}from"./App-Beqn1ldu.js";import{e as Yt}from"./index-DawRJxOm.js";import{S as Zt}from"./SkeletonLoader-BEiEaGGf.js";import"./pdf-wbV6RFuj.js";import"./ui-CHfsb5jC.js";function rt(p){try{return new Date(p).toLocaleDateString("es-CO",{year:"numeric",month:"long",day:"numeric"})}catch{return p}}function Jt(p){return`
  <div class="header">
  ...
  `}function Kt(p,be,B,q){const W=rt(p.fecha_limite),j=rt(new Date().toISOString().split("T")[0]);return`
  <div class="page-item">
    ${Jt(be)}
  ...
  `}function lt(p,be){Array.isArray(p)||(p=[p]);const B=p[0]?.estudiante||"",q=p.map((P,G)=>Kt(P,be,!0,G===p.length-1)).join(""),W=`<!DOCTYPE html>
<html>
<head>
<meta charset="utf-8">
