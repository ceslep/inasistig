import{p as Gt,s as ie,b as It,o as Nt,j as D,e as Mt,$ as Ot,f as Ae,b1 as d,k as r,i as T,m as e,A as ne,t as k,r as o,g as v,y as a,B as ge,a8 as Ht,al as tt,h as Rt,N as w,v as R,q as U,l as at,n as Ee,bk as Ut,x,J as st,d as qt}from"./svelte-CHP0J0Uw.js";import{p as Vt,c as Bt}from"./App-B6_HZTSz.js";import{e as Zt}from"./index-B-tn3q33.js";import{S as Jt}from"./SkeletonLoader-D3gkMfZ2.js";import"./pdf-wbV6RFuj.js";import"./ui-CHfsb5jC.js";function rt(p){try{return new Date(p).toLocaleDateString("es-CO",{year:"numeric",month:"long",day:"numeric"})}catch{return p}}function Kt(p){return`
  <div class="header">
  ...
  `}function Wt(p,be,B,q){const Y=rt(p.fecha_limite),$=rt(new Date().toISOString().split("T")[0]);return`
  <div class="page-item">
    ${Kt(be)}
    ...
    <table class="info-table">
      ...
      <tr>
        ...
        <td class="info-cell"><span class="lbl">Fecha de Entrega</span><span class="val">${$}</span></td>
  ...
  `}function lt(p,be){Array.isArray(p)||(p=[p]);const B=p[0]?.estudiante||"",q=p.map((C,L)=>Wt(C,be,!0,L===p.length-1)).join(""),Y=`<!DOCTYPE html>
<html>
<head>
<meta charset="utf-8">
