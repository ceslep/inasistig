import{p as Gt,s as ie,b as It,o as Nt,j as C,e as Mt,$ as Ot,f as Se,aW as d,k as r,i as T,m as e,A as ne,t as w,r as o,g as v,y as a,B as ge,a8 as Ht,ao as tt,h as Rt,N as $,v as z,q as U,l as at,n as Ae,bq as Ut,x,J as st,d as qt}from"./svelte-DSZBSnyz.js";import{p as Vt,c as Bt}from"./App-jXo-bL8P.js";import{e as Wt}from"./index-mCBcoqLP.js";import{S as Zt}from"./SkeletonLoader-BF0sXOMp.js";import"./pdf-wbV6RFuj.js";import"./ui-CHfsb5jC.js";function rt(p){try{return new Date(p).toLocaleDateString("es-CO",{year:"numeric",month:"long",day:"numeric"})}catch{return p}}function Jt(p){return`
  <div class="header">
  ...
  `}function Kt(p,be,B,q){const Y=rt(p.fecha_limite),j=rt(new Date().toISOString().split("T")[0]);return`
  <div class="page-item">
    ${Jt(be)}
  ...
  `}function lt(p,be){Array.isArray(p)||(p=[p]);const B=p[0]?.estudiante||"",q=p.map((P,G)=>Kt(P,be,!0,G===p.length-1)).join(""),Y=`<!DOCTYPE html>
<html>
<head>
<meta charset="utf-8">
